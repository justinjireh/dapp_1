...
const providerOptions = {
  walletconnect: {
    ...
    options: {
      ...
      rpc: {
        250: "https://broken-shy-meadow.fantom.discover.quiknode.pro/ae51433c9d36b055d0726672e7316e88db2d9c5c/", // Fantom Chain
      },
    },
  },
  walletlink: {
    ...
    options: {
      appName: "Little Clay Cloud", // Required
      infuraId: "", // Required unless you provide a JSON RPC url; see `rpc` below
      rpc: "https://broken-shy-meadow.fantom.discover.quiknode.pro/ae51433c9d36b055d0726672e7316e88db2d9c5c/", // Optional if `infuraId` is provided; otherwise it's required
